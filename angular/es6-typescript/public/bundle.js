...
// enhancedLoop();
        ...
        function deepDestructuringObject() {
            ...
            var categorizedEmployee = function (_a) {
                var _b = _a.workAddress.city, city = _b === void 0 ? '' : _b, _c = _a.position.department.name,
                    departmentName = _c === void 0 ? '' : _c;
                return {
        ...
        function destructuringArray() {
            ...
            var _a = names || [], _b = _a[0], firstName = _b === void 0 ? 'Kripa' : _b, secondName = _a[1],
                more = _a.slice(2);
        ...
        function restOperator() {
            ...
            var printName = function () {
                ...
                return items.forEach(function (value) {
