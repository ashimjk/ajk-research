package io.ashimjk.spring.dirty.context;

import io.ashimjk.spring.dirty.context.without.Employee;
...
public class WithDirtiesContextTest {
    ...
    @Configuration
    @ComponentScan("io.ashimjk.spring.dirty.context")
    static class Config {
