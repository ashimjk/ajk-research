...
public class PathBasedKeycloakConfigResolver implements KeycloakConfigResolver {
    ...
    private AdapterConfig buildAdapterConfig() {
        ...
        adapterConfig.setRealm("scope-based");
        ...
        PolicyEnforcerConfig policyEnforcerConfig = readPolicyConfig(POLICY_FILE);
    ...
    private String readFile(String filePath) throws IOException {
        ...
        InputStream is = PathBasedKeycloakConfigResolver.class.getClassLoader()
